 ...
 * 
 * @author hezhiqun
 * v1.10 更新内容(2013-8-22)
 * 	- 添加 查询绑卡信息(列表) 接口:getBinds
 *  - 添加 绑卡CVV2鉴权 接口: bindCheck
 *  - 添加 银行卡信息查询 接口: bankcardCheck
 *  
 */
// 包含RSA、AES相关加解密包
 ...
 * @var string
 */
define('YEEPAY_PRODUCT_CATALOG_VIRTUAL','1');
/**
 * 信用卡还款
 * @var string
 */
define('YEEPAY_PRODUCT_CATALOG_REPAYMENT','2');
/**
 * 公共事业缴费
 * @var string
 */
define('YEEPAY_PRODUCT_CATALOG_PUBIC_SERVICES','3');
/**
 * 手机充值
 * @var string
 */
define('YEEPAY_PRODUCT_CATALOG_PHONE_CHARGE','4');
/**
 * 普通商品
 * @var string
 */
define('YEEPAY_PRODUCT_CATALOG_OTHER','5');
 ...
 * @var int
 */
define('YEEPAY_IDENTITY_TYPE_IMEI',0);
/**
 * 网卡地址
 * @var int
 */
define('YEEPAY_IDENTITY_TYPE_MAC',1);
/**
 * 用户ID
 * @var int
 */
define('YEEPAY_IDENTITY_TYPE_UID',2);
/**
 * 用于EMAIL地址
 * @var int
 */
define('YEEPAY_IDENTITY_TYPE_EMAIL',3);
/**
 * 用户手机号
 * @var int
 */
define('YEEPAY_IDENTITY_TYPE_PHONE',4);
/**
 * 用户身份证号
 * @var int
 */
define('YEEPAY_IDENTITY_TYPE_ID',5);
/**
 * 用户纸质订单协议号
 * @var int
 */
define('YEEPAY_IDENTITY_TYPE_AGREEMENT',6);
...
// 	private $API_Merchant_Base_Url = 'https://ok.yeepay.com/merchant/';
	 ...
	 * @return array
	 */
	public function bindPay($bind_id,$order_id,$transtime,$amount,$product_catalog,$identity_id,$identity_type,$user_ip,$callbackurl='',$fcallbackurl='',$currency=156,$product_name='',$product_desc='',$other=''){
		$query = array(
		...
		return $this->post(YEEPAY_PAY_API, 'bankcard/bind/pay/async', $query);
	}
	/**
	 * 返回绑卡信息列表
	 * 
